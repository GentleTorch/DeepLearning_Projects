...
def main():
    ...
    videWriter=cv2.VideoWriter("label.avi",cv2.VideoWriter_fourcc('M','J','P','G'),fps,(width,height))
    ...
    print("Total Cost {:.3f}ms, mean cost {:.3f}ms, frame cnt {}".format(total_cost_time*1000,total_cost_time/cnt*1000,cnt))
